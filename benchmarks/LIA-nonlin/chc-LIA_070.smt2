; ./hcai/./svcomp/O0/Ackermann01_true-unreach-call_true-no-overflow_000.smt2
(set-logic HORN)
...
(assert
  (forall ( (A Bool) (B Bool) (C Bool) (D Bool) (E Int) (F Int) (G Bool) (H Bool) (I Int) (J Bool) (K Bool) (L Bool) (M Bool) (N Bool) (O Bool) (P Bool) (v_16 Bool) (v_17 Bool) ) 
    (=>
      ...
      (a!2 (or (not M) (not (= (<= 0 F) H))))
      (a!3 (or (not M) (not (= (<= 0 E) G))))
      (a!4 (or (not M) (not (= (<= I (- 1)) K))))
      (a!5 (= A (or (not (<= E 3)) (not (>= E 0))))))
  (and (= v_16 false)
       (= v_17 false)
       (or (not D) a!1)
       (or (not D) (and B D))
