...
(assert
  (forall ( (A Bool) (B Bool) (C Bool) (D Bool) (E Bool) (F Int) (G Int) (H Int) (I Int) (J Int) (K Int) (L Bool) (M Int) (N Bool) (O Bool) (P Int) (Q Int) (R Int) (S Int) (T Int) (U Int) (V Bool) (W Bool) (X Bool) (Y Bool) (Z Bool) (A1 Bool) (B1 Bool) (C1 Bool) (D1 Bool) (E1 Bool) (F1 Bool) (G1 Bool) (H1 Int) (I1 Bool) (J1 Int) (K1 Bool) (L1 Int) (M1 Int) (N1 Int) (O1 Int) (P1 Int) (Q1 Int) (R1 Bool) (S1 Bool) (T1 Bool) (U1 Int) (V1 Bool) (W1 Int) (X1 Int) (Y1 Int) (Z1 Int) (A2 Int) (B2 Int) (C2 Bool) (D2 Bool) (E2 Bool) ) 
    (=>
      (and
        (excludes12_fun V W X Y Z A1 B1 C1 D1 E1 F1 G1 B)
        (Sofar_step A O C D D2 E2)
        (DRAGON_step V
             W
             X
             Y
             ...
             B2
             C2)
        (First_step H1 U M N U1 V1)
        (let ((a!1 (= I1 (or (not O) (= (+ P Q R S T) U))))
      (a!2 (= A (and B (not (<= H1 0))))))
  (and (= N K1)
       a!1
       (= C S1)
       (= D T1)
