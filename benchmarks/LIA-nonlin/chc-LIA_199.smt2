; ./llreve/./smt2/clausified/faulty__add-horn!_000.smt2
(set-logic HORN)
...
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) (E Int) (F Int) ) 
    (=>
      (and
        (and (= D (+ (- 1) B)) (= D F) (not (= C 0)) (= C (+ 1 A)) (= C E) (= E 2))
      )
      (INV_REC_f__1_PRE A B)
    )
  )
  ...
  (forall ( (A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (v_7 Int) ) 
    (=>
      (and
        (INV_REC_f^f_PRE A B C D)
        (INV_REC_f__1 F G E)
        (and (= B (+ (- 1) G)) (not (= A 0)) (= A (+ 1 F)) (= C 2) (= v_7 D))
      )
      (INV_REC_f^f A B C D E v_7)
    )
  )
  ...
  (forall ( (A Int) (B Int) (C Int) (D Int) ) 
    (=>
      (and
        ...
        (and (not (= C 2)) (not (= C 1)) (not (= C 0)) (= C (+ 1 A)) (= D (+ (- 1) B)))
      )
      (INV_REC_f__2_PRE A B)
    )
  )
  ...
  (forall ( (A Int) (B Int) (C Int) (D Int) (E Int) ) 
    (=>
      (and
        (INV_REC_f__2_PRE A B)
        (INV_REC_f__2 D E C)
        (and (not (= A 1)) (not (= A 0)) (= A (+ 1 D)) (= B (+ (- 1) E)) (not (= A 2)))
      )
      (INV_REC_f__2 A B C)
    )
  )
