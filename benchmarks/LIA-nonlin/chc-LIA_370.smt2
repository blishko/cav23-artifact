; ./sv-comp/./2015-05-26/ALIA/sdv/sdv1439_000.smt2
(set-logic HORN)
...
(declare-fun |P!!5| ( Int Int Int Int Int Int Int Bool Int Int Int Int Int Int Int Int Int ) Bool)
...
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) (I Int) (J Bool) (K Int) (L Int) (M Int) (N Int) (O Int) (P Int) (Q Int) (R Int) (S Int) (T Int) (U Int) (V Int) (W Int) (X Int) ) 
    (=>
      (and
        (Proc21 X W J P O N)
        (P!!5 V U O N M L K J I H G F E D C B A)
        (Proc11 X W J V)
        (Proc18 X W J U)
        (Proc12 X W J T)
        (Proc17 X W J S)
...
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) (I Int) (J Bool) (K Int) (L Int) (M Int) (N Int) (O Int) (P Int) (Q Int) ) 
    (=>
      (and
        (Proc13 O N J F)
        (P!!6 Q P O N M L J E D C B A)
        (Proc19 O N J K)
        (Proc9 O N J I)
        (Proc15 O N J H)
        (Proc16 O N J G)
