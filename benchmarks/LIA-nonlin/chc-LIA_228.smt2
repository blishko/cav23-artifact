; ./hopv/./lia/termination/Ackermann06_000.smt2
(set-logic HORN)
...
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) (I Int) (J Int) (K Int) (L Int) (M Int) (N Int) (O Int) (P Int) (Q Int) (R Int) (S Int) (T Int) (U Int) ) 
    (=>
      (and
        (|ack_1030$unknown:8| A G F E D C B U)
     ...
     (not (= (= 0 T) (= O 0))))
      ...
      (|ack_without_checking_1087$unknown:26| A G F E D C B U)
    )
  )
)
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) (I Int) (J Int) (K Int) (L Int) (M Int) (N Int) (O Int) (P Int) (Q Int) (R Int) (S Int) (T Int) (U Int) (V Int) ) 
    (=>
      (and
        (|ack_1030$unknown:8| G F E D C B A V)
        (|ack_without_checking_1087$unknown:27| H G F E D C B A V)
     ...
     (not (= (= 0 U) (= P 0))))
      ...
      (|ack_1030$unknown:9| H G F E D C B A V)
    )
  )
)
(assert
...
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) (I Int) (J Int) (K Int) (L Int) (M Int) (N Int) (O Int) (v_15 Int) (v_16 Int) (v_17 Int) ) 
    (=>
      (and
        (|ack_1030$unknown:18| M L I E J K v_15 v_16 v_17)
...
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) (I Int) (J Int) (K Int) (L Int) (M Int) (N Int) (O Int) (P Int) (v_16 Int) (v_17 Int) (v_18 Int) (v_19 Int) (v_20 Int) (v_21 Int) (v_22 Int) ) 
    (=>
      (and
        (|ack_without_checking_1087$unknown:26| I H G F E D C B)
        (|ack_without_checking_1087$unknown:27| O N I E J v_16 v_17 v_18 v_19)
  ...
  (forall ( (A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) (I Int) (J Int) (K Int) (L Int) (M Int) (v_13 Int) (v_14 Int) (v_15 Int) ) 
    (=>
     ...
     (= v_15 I))
      ...
      (|ack_1030$unknown:17| K H D I J v_13 v_14 v_15)
    )
  )
)
(assert
