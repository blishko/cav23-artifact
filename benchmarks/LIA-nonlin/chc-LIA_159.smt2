; ./kind2/./data/MESI_1_e2_162_e7_1545_000.smt2
(set-logic HORN)
...
(assert
  (forall ( (A Bool) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) (I Bool) (J Bool) (K Bool) (L Bool) (M Bool) (N Int) (O Bool) (P Bool) (Q Bool) (R Bool) (S Bool) (T Bool) (U Bool) (V Int) (W Int) (X Int) (Y Int) (Z Bool) (A1 Bool) (B1 Bool) (C1 Int) (D1 Int) (E1 Int) (F1 Int) (G1 Bool) ) 
    (=>
      (and
        (mesi_step O P Q R N B C D E F G H I C1 D1 E1 F1 G1)
        (excludes4_fun O P Q R J)
        (Sofar_step A M K L A1 B1)
        (and (= F W)
     (= G X)
     (= H Y)
     (= K T)
