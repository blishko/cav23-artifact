; ./kind2/./data/ILLINOIS_r4a_000.smt2
(set-logic HORN)
...
(let ((a!3 (or Q (and (or (not R) a!2) (or R (= W C1)))))
      ...
      (a!21 (or (and (or (not T) a!20) (or T (= V D1))) S))
...
(assert
  (forall ( (A Bool) (B Bool) (C Bool) (D Int) (E Int) (F Int) (G Int) (H Int) (I Int) (J Int) (K Bool) (L Bool) (M Int) (N Int) (O Bool) (P Bool) (Q Bool) (R Bool) (S Bool) (T Bool) (U Bool) (V Bool) (W Bool) (X Int) (Y Bool) (Z Int) (A1 Int) (B1 Int) (C1 Int) (D1 Int) (E1 Bool) (F1 Bool) (G1 Bool) (H1 Int) (I1 Int) (J1 Int) (K1 Int) (L1 Int) (M1 Bool) (N1 Bool) (O1 Bool) ) 
    (=>
      (and
        (excludes9_fun O P Q R S T U V W A)
        (Sofar_step A L B C N1 O1)
        (illinois_step O P Q R S T U V W X D M E N F G H I J K H1 I1 J1 K1 L1 M1)
        (and (= G A1)
     (= H B1)
     (= I C1)
     (= J D1)
     ...
     (= F Z))
      ...
      (top_step O P Q R S T U V W X Y Z A1 B1 C1 D1 E1 F1 G1 H1 I1 J1 K1 L1 M1 N1 O1)
    )
  )
)
(assert
