; ./kind2/./data/FIREFLY_11_e3_2076_e1_1270_000.smt2
(set-logic HORN)
...
(assert
  (forall ( (A Bool) (B Bool) (C Bool) (D Bool) (E Bool) (F Bool) (G Bool) (H Bool) (I Bool) (J Bool) (K Int) (L Bool) (M Bool) (N Bool) (O Bool) (P Bool) (Q Bool) (R Bool) (S Bool) (T Int) (U Int) (V Int) (W Int) (X Int) (Y Int) (Z Int) (A1 Int) (B1 Int) (C1 Int) (D1 Int) (E1 Bool) (F1 Int) (G1 Int) (H1 Int) (I1 Int) (J1 Int) (K1 Int) (L1 Bool) ) 
    (=>
      ...
      (a!24 (or (not C) (= X (+ 2 Y (* (- 1) Z)))))
      (a!27 (and (or F (= X Y)) (or (not F) (= X (+ 2 Y)))))
      (a!29 (and (or E (= U C1)) (or (not E) (= U (+ (- 1) C1)))))
      (a!31 (and (or I (= U C1)) (or (not I) (= U (+ (- 1) C1)))))
      (a!33 (and (or H (= U C1)) (or (not H) (= U (+ (- 1) C1)))))
      (a!35 (and (or C (= U C1)) (or (not C) (= U (+ (- 1) C1)))))
      (a!37 (and (or F (= U C1)) (or (not F) (= U (+ (- 1) C1)))))
      (a!39 (and (or B (= U C1)) (or (not B) (= U (+ (- 1) C1))))))
(let ((a!5 (or Q (and (or (not R) a!4) (or R (= V B1)))))
      (a!11 (or P (and a!10 (or S (= W Z)))))
      (a!20 (or (and (or (not S) a!19) (or S (= X Y))) R))
      (a!25 (or (not N) (and (or C (= X Y)) a!24)))
      (a!30 (or R (and (or (not S) a!29) (or S (= U C1))))))
...
(let ((a!15 (or N (and a!13 (or (not O) a!14))))
      (a!26 (or M (and (or N (and a!22 a!23)) a!25)))
      (a!34 (or N (and a!32 (or (not Q) a!33)))))
(let ((a!18 (or J
                (and a!8
                     (or (not M) a!9)
                     (or L (and a!15 a!16))
                     (or (not L) a!17))))
      (a!28 (or J (and a!26 (or (not M) a!27) (= K D1))))
      (a!36 (or M (and a!34 (or (not N) a!35)))))
(let ((a!38 (or L (and a!36 (or (not M) a!37)))))
(let ((a!40 (or J (and a!38 (or (not L) a!39)))))
  (and (= G1 W)
       (= H1 0)
       (= I1 V)
       (= J1 U)
  ...
  (forall ( (A Bool) (B Bool) (C Bool) (D Bool) (E Int) (F Int) (G Int) (H Int) (I Int) (J Int) (K Int) (L Int) (M Int) (N Bool) (O Bool) (P Int) (Q Bool) (R Bool) (S Bool) (T Bool) (U Bool) (V Bool) (W Bool) (X Bool) (Y Int) (Z Bool) (A1 Int) (B1 Int) (C1 Int) (D1 Int) (E1 Int) (F1 Int) (G1 Bool) (H1 Bool) (I1 Bool) (J1 Int) (K1 Int) (L1 Int) (M1 Int) (N1 Int) (O1 Int) (P1 Bool) (Q1 Bool) (R1 Bool) ) 
    (=>
      (and
        ...
        (firefly_step Q R S T U V W X Y E F P G H I J K L M N J1 K1 L1 M1 N1 O1 P1)
        (let ((a!1 (= Z (or (not O) (not (<= 2 P)))))
      (a!2 (= A (and B (not (<= 5 Y)) (>= Y 0)))))
  (and (= I B1)
       (= J C1)
       (= K D1)
       (= L E1)
