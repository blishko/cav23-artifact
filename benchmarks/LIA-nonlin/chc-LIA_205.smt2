; ./llreve/./smt2/clausified/rec__limit3_000.smt2
(set-logic HORN)
...
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) ) 
    (=>
      (and
        (and (= C (+ 1 A)) (= C D) (not (<= D 1)) (not (<= C 1)) (= D (+ 1 B)))
      )
      (INV_REC_f^f_PRE A B)
    )
  )
  ...
  (forall ( (A Int) (B Int) (C Int) (D Int) (E Int) (v_5 Int) ) 
    (=>
      (and
        (INV_REC_f^f_PRE A B)
        (INV_REC_f__2 E D)
        (and (= B (+ 1 E)) (>= D 0) (<= A 1) (not (<= B 1)) (= (+ B D) C) (= v_5 A))
      )
  ...
  (forall ( (A Int) (B Int) (C Int) (D Int) (v_4 Int) ) 
    (=>
      (and
        (INV_REC_f^f_PRE A B)
        (INV_REC_f__2 D C)
        (and (not (>= C 0)) (not (<= B 1)) (<= A 1) (= B (+ 1 D)) (= v_4 A))
      )
      (INV_REC_f^f A B v_4 C)
    )
  )
)
(assert
...
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) ) 
    (=>
      (and
        (INV_REC_f^f_PRE C D)
        (and (= C (+ 1 A)) (not (<= D 1)) (not (<= C 1)) (= D (+ 1 B)))
      )
      (INV_REC_f^f_PRE A B)
    )
  )
...
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) ) 
    (=>
      (and
        (INV_REC_f__2 D C)
        (and (not (= A (+ B C))) (= A B) (>= C 0) (not (<= B 1)) (<= A 1) (= B (+ 1 D)))
      )
      CHC_COMP_FALSE
    )
  )
...
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) ) 
    (=>
      (and
        (INV_REC_f__2 D B)
        (and (= A C) (= C (+ 1 D)) (not (>= B 0)) (<= A 1) (not (<= C 1)) (not (= A B)))
      )
      CHC_COMP_FALSE
    )
  )
