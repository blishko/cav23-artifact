...
${script_dir}/run_golem.sh ${benchmark_dir} $timelimit bmc
${script_dir}/run_golem.sh ${benchmark_dir} $timelimit kind
${script_dir}/run_golem.sh ${benchmark_dir} $timelimit imc
